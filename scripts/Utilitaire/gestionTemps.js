...
let currentDay = today.toLocaleDateString('fr-FR', options); // renvoie une chaine de caractères 
console.log(currentDay); // jeudi (jour actuel en fonction)
//console.log(today); // Thu Oct 28 2021 18:54:14 

currentDay = currentDay.charAt(0).toUpperCase() + currentDay.slice(1); 
//1ère lettre en MAJ + affiche le reste du mot
...
// On concatène en re recoupant pour avoir dimanche à mercredi inclus
